...
class RegisterForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['last_name'].help_text = '<span class="form-help-text text-muted text-align:"><small>100 characters max. Letters and /-/ only for First and Last name .</small></span>'

        self.fields['username'].widget.attrs['class'] = 'form-control'
        self.fields['username'].widget.attrs['placeholder'] = 'User Name'
        self.fields['username'].label = ''
        self.fields['username'].help_text = '<span class="form-help-text text-muted"><small>(Field required). 150 characters max. Letters, digits and @/./+/-/_ only.</small></span>'
        ...
        self.fields['password2'].help_text = '<span class="form-help-text text-muted"><small>Enter the same password as before, for verification.</small></span>'
