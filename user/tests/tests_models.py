...
class CreateUserTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        print(
            "\n\n ** Loading  necessary component for testing User's model with setUpTestDAta **\n\n",
        )
...
class ProfileTest(TestCase):
    ...
    def setUpTestData(cls):
        ...
        print(
            "\n\n ** Loading  necessary component for testing Profile's model with setUpTestDAta **\n\n",
        )
    ...
    def test_user_profile_created(self):
        ...
        profile.date_of_birth = datetime.datetime.strptime(
            "1992-10-08", "%Y-%m-%d"
        ).date()
