...
class Movie(BaseModel):
    ...
    genre = models.JSONField(blank=True, null=True)  # will be a list of strings
    release_date = models.DateField(blank=True, null=True)
    origin_country = models.JSONField(blank=True, null=True)  # list of strings
    original_language = models.CharField(max_length=50, blank=True, null=True)
    spoken_languages = models.JSONField(blank=True, null=True)  # list of strings
    length = models.IntegerField(blank=True, null=True)
    # Cast and Prod
    production = models.JSONField(blank=True, null=True)  # list of strings
    director = models.JSONField(blank=True, null=True)  # list of dicts
    writer = models.JSONField(blank=True, null=True)  # list of strings
    casting = models.JSONField(
        blank=True, null=True
    )  # list of dicts: [{"name": actor_name, "role": character_name}, ..]
    ...
    vote_average = models.FloatField(
        ...
        # error_messages="The vote value must be between 0 and 10. Negative value and over 10 are not valid",
        blank=True,
        null=True,
    )  # for TMDB rating
    ...
    imdb_rating = models.FloatField(
        blank=True, null=True
    )  # to fetch externally their rating
