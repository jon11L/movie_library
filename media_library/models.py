...
class Media(BaseModel):
    ...
    # -- ext_id field to contains different vote platform: TMDB - IMDB - Rottentomatoes ...
    ...
    def render_genre(self):
        """
        return the Media.genre attribute in without quotes and [],
